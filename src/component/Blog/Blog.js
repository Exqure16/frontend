                    ...
                    <BlogHero>
                        <div className="hero-card-info">
                            <div className="body">
                                ...
                                <h3>
                                    Follow the trend with the new age Technology
                                </h3>
                                <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem pariatur eveniet iste a impedit officia quasi, voluptates ea, totam nulla nobis, dicta repellat voluptatem harum aliquid eligendi fuga sunt facilis
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem pariatur eveniet iste a impedit 
                                </p>
                            </div>
                    ...
                    <StyledBlogs>
                        <BlogCard>
                                ...
                                <div className="body">
                                    ...
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti, ab minima numquam eveniet, sequi molestias nisi...
                                    </p>
                                </div>
                                <div className="footer flex">
                                    <div className="flex1">
                            ...
                            <BlogCard>
                                ...
                                <div className="footer flex">
                                    ...
                                    <div className="lat">
                                        <a className="link la" href="#">Read Article</a>
                                    </div>
                                </div>
                            </BlogCard>
                            <BlogCard>
