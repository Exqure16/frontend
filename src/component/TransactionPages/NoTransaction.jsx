    ...
    <>
      ...
      <Section>
        <div className='transaction-info'>
          ...
          <p>
            To start transactions with Exqure, please verify your account. Do
        ...
        <div className='transactions'>
            ...
            <tr>
              ...
              <th>
                <button className='sort'>
                  <CgSortAz className='sort-icon' /> Sort
                </button>
              </th>
            </tr>
          </table>
          ...
          <p>
            You have no transaction with us yet. Click on "+" below to create
            one
          </p>
          <BsPlusSquareFill
            style={{
